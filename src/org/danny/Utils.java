...
public class Utils {
    public static Integer sum(MyList<Integer> integerList) {
        ...
        for (Integer i = 0; i < integerList.size(); i++) {
            sum += integerList.get(i).value;
        }
        return sum;
    }

    public static Integer smartSum(MyList<Integer> integerList) {
        // REMEMBER THIS WELL,
        // THIS IS THE RIGHT WAY TO USE A CURSOR WHEN GOING THROUGH A LIST
        // !!!!!
    ...
    public static Integer product(MyList<Integer> integerList) {
        ...
        for (Integer i = 0; i < integerList.size(); i++) {
            product = product * integerList.get(i).value;
        }

        return product;
    }

    public static Integer smartProduct(MyList<Integer> integerList) {
        Integer product = 1;
        MyListElement<Integer> cursor = integerList.head;
    ...
    public static Boolean smartAnyPositive(MyList<Integer> integerList) {
        Boolean anyPositive = false;
    ...
    public static Boolean smartAnyNegative(MyList<Integer> integerList) {
        Boolean anyNegative = false;
    ...
    public static Boolean smartAnyZero(MyList<Integer> integerList) {
        Boolean anyZero = false;
